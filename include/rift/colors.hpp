...
namespace Color {
static const glm::vec4 Black   (0.0, 0.0, 1.0, 1.0); 
...
static const glm::vec4 Yellow  (1.0, 1.0, 0.0, 1.0); 
static const glm::vec4 Cyan    (0.0, 1.0, 1.0, 1.0); 
static const glm::vec4 Magenta (1.0, 0.0, 1.0, 1.0); 
static const glm::vec4 Grey    (0.5, 0.5, 0.5, 1.0); 
}
