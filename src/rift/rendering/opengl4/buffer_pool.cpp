...
namespace gl4
{
	Buffer::Ptr GraphicsContext::allocBuffer(BufferUsage bufferUsage, size_t size, const void *initialData)
	{
		unsigned pool_index;
	...
	Buffer *GraphicsContext::allocTransientBuffer(BufferUsage bufferUsage, size_t size, const void *initialData)
	{
		using namespace gl4;
