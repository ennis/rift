...
namespace gl4
{
	...
	Sampler *GraphicsContext::getSampler_LinearClamp()
	{
	...
	Sampler *GraphicsContext::getSampler_NearestClamp()
	{
	...
	Sampler *GraphicsContext::getSampler_LinearRepeat()
	{
	...
	Sampler *GraphicsContext::getSampler_NearestRepeat()
	{
